...
function initAutocomplete() {
  ...
  var mymarkers = [
		...
		["GTRI conference center(GCATT)", 33.7858, -84.395],
		["Georgia Public Broadcasting", 33.7859, -84.3955],
		...
		["831 Marietta St.", 33.7812, -84.4159],
		...
		["Burger Bowl Field", 33.7784, -84.4027],
		...
		["Kessler Campanile", 33.7743, -84.3982],
		...
		["Engineering Center", 33.787, -84.4058],
  ...
  var infoWindowContent = [
		...
		['<div class="info_content">' + '<h3>GTRI conference center(GCATT)</h3>' + '</div>'],
		['<div class="info_content">' + '<h3>Georgia Public Broadcasting</h3>' + '</div>'],
		...
		['<div class="info_content">' + '<h3>831 Marietta St.</h3>' + '</div>'],
		...
		['<div class="info_content">' + '<h3>Burger Bowl Field</h3>' + '</div>'],
		...
		['<div class="info_content">' + '<h3>Kessler Campanile</h3>' + '</div>'],
		...
		['<div class="info_content">' + '<h3>Engineering Center</h3>' + '</div>'],
  ...
  for(i = 0; i < mymarkers.length; i++ ) {
    ...
    //   })(marker, i));
  		...
  		marker.setMap(map);
      // var position = new google.maps.Marker(markers[i][0], markers[i][1]);
 ...
 //  var marker=new google.maps.Marker({
	// 	position:{lat: 33.7767415, lng: -84.3963708},
	// });

 //  marker.setMap(map);

	// myDataRef.on('value', function(snapshot) {
	// 	var coordinates = snapshot.text.split(',');
...
// var myDataRef = new Firebase('https://the-flu-network.firebaseio-demo.com/');
...
// function addToDatabase() {
	...
	// buildingName = "Howell Residence Hall";
	// myDataRef.push({firstname: first_name, lastname: last_name, email: email, count: count});	
	count = 1;
	myDataRef.on("value", function(snapshot) {
